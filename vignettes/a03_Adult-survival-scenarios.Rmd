...
Working on it .........
Here, I (Chrissy) have inserted an example using a new function for a threshold-based approach.
...
data_adults_500<- nohunt_threshold_500$vec[,4] #error incorrect number of dimesnsions
plot(data_adults, type='l', lwd=2, xlab='Time', ylab='N adult females')
lines(0:100, data_adults_500, lty = 3, col = "red")
...
plot(data_adults_stoch, type='l', lwd=2, xlab='Time', ylab='N adult females')
lines(0:100, data_adults_stoch_500, lty = 3, col = "red")
```
