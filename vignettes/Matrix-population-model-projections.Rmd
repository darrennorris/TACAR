...
3 of the data.frame created earlier by the function "pop01_param_poun".
...
range: `r change_q25` - `r change_q75` % decline).
 ...
 Endangered (A3bd), is threfore a precautionary IUCN Red List assessment.    
      ...
      - Losses are potentially buffered by an overly generous 20% limit to increases in unaccesible populations.
      - Population projections use the earliest likely breeding age. 
      - Hunting of females was limited to 10% per year in the most pessimistic scenarios.
