...
shaded area is the interquartile range (IQR). As the basin-country combinations 
cover different areas, calculations of mean and 
IQR are obtained using estimates weighted by the river length.
