...
work with these MPMs: [Rcompadre](https://jonesor.github.io/Rcompadre/index.html) and [Rage](https://jonesor.github.io/Rage/).

The code below creates a compadre database object from the matrix at line 
3 of the data.frame created by the function "pop01_param_poun".
...
Now we have seperated into the growth/survival and reproduciton matrixes 
we can obtain many useful summaries of age related life histroy 
traits using functions in the package Rage (https://jonesor.github.io/Rage/).

The code below provides generation time and life expectancy.
```{r gen-time}
...
# Approx 90 - 120 minutes. 1,212,000 rows. Projections quick. Summaries slow.
# 19:41 - 21:42
...
The scenarios are used to help inform IUCN Red List  and 
...
- Join points with scenarios and population projections.
...
# This file is used in testmap. 1060311 rows 15/8/2024.
...
interquartile range of generation length estimates (35 and 45 year, 
