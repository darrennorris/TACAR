...
ffr_ap <- read_sf(rin)
ffr_ap$myval <- 1
ffr_ap_3395 <- ffr_ap |> st_transform(3395)
# 1 to 4 close to Norris et al. 2019. Including 5 adds Capivara/Primeiro Braco
# I.e. hard to pass with voadeira / rabeta
...
ffr$myval <- 1
ffr_3395 <- ffr |> st_transform(3395)
rm(ffr)
```
...
Overlay original point locations and new access based on Free-flowing rivers.
...
# So will inflate importance of accessible and unprotected
sr_new |> data.frame() |> 
